...
public class BootReceiver extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    SharedPreferences prefs = context.getSharedPreferences(PanoptesConstants.SHARED_PREFERENCE_FILE, Context.MODE_PRIVATE);
  	boolean runOnce = prefs.getBoolean(PanoptesConstants.SP_KEY_RUN_ONCE, false);
  	if (runOnce) {
      ...
      boolean followLocationChanges = prefs.getBoolean(PanoptesConstants.SP_KEY_FOLLOW_LOCATION_CHANGES, true);
