...
package com.jfenton.panoptes.content_providers;
...
public class QueuedCheckinsContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.jfenton.panoptes.provider.checkins/checkins");
  ...
  static {
   ...
   uriMatcher.addURI("com.jfenton.panoptes.provider.checkins", "checkins", CHECKINS);
   uriMatcher.addURI("com.jfenton.panoptes.provider.checkins", "checkins/*", CHECKIN_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      case CHECKINS: return "vnd.android.cursor.dir/vnd.panoptes.checkin";
      case CHECKIN_ID: return "vnd.android.cursor.item/vnd.panoptes.checkin";
