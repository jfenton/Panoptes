...
public class PlacesContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.jfenton.panoptes.provider.places/places");
  ...
  static {
   ...
   uriMatcher.addURI("com.jfenton.panoptes.provider.places", "places", PLACES);
   uriMatcher.addURI("com.jfenton.panoptes.provider.places", "places/*", PLACE_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      case PLACES: return "vnd.android.cursor.dir/vnd.panoptes.place";
      case PLACE_ID: return "vnd.android.cursor.item/vnd.panoptes.place";
